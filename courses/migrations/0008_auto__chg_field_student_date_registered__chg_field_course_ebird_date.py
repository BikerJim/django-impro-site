...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.date_registered'
        db.alter_column(u'courses_student', 'date_registered', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

        # Changing field 'Course.ebird_date'
        db.alter_column(u'courses_course', 'ebird_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Student.date_registered'
        db.alter_column(u'courses_student', 'date_registered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Course.ebird_date'
        db.alter_column(u'courses_course', 'ebird_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'ebird_disc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
