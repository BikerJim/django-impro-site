...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.total_paid'
        db.add_column(u'courses_student', 'total_paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Course.display'
        db.add_column(u'courses_course', 'display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.total_paid'
        db.delete_column(u'courses_student', 'total_paid')

        # Deleting field 'Course.display'
        db.delete_column(u'courses_course', 'display')
