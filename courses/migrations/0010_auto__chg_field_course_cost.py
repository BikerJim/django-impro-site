...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.cost'
        db.alter_column(u'courses_course', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Course.cost'
        db.alter_column(u'courses_course', 'cost', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'cost': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
        ...
        u'courses.student': {
            ...
            'total_paid': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '6', 'decimal_places': '2'})
        },
        u'events.event_date': {
