...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.date_registered'
        db.add_column(u'courses_student', 'date_registered',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.date_registered'
        db.delete_column(u'courses_student', 'date_registered')
