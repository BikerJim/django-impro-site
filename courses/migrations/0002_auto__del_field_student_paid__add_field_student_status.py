...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'courses_student', 'paid')

        # Adding field 'Student.status'
        db.add_column(u'courses_student', 'status',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'courses_student', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Student.status'
        db.delete_column(u'courses_student', 'status')
